<template>
  <div>
    ...
    <el-table :data="tableData5"  class="table-content">
        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="电话">
              <span>{{ props.row.user.telephone }}</span>
            </el-form-item>
            <el-form-item label="地址">
              <span>{{ props.row.user.address }}</span>
            </el-form-item>
            <el-form-item label="已提现金额">
              <span>{{ props.row.user.encashTotal }}</span>
            </el-form-item>
      ...
      <el-table-column label="支付宝号" prop="user.alipay">
      </el-table-column>
      <el-table-column label="微信号" prop="user.wechat">
      </el-table-column>
